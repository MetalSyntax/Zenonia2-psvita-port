...
Recopiladas durante el port de Zenonia 2. Todas asumen un proyecto so-loader
...
- **`scripts/deploy_and_launch_vita3k.sh`** — para pruebas en el emulador Vita3K (macOS): copia el
  ...
  completo) y relanza el emulador. Requiere el symlink `~/zn2-src` y build dir descritos en el script.
