...
BASE_DIR="/Volumes/Seagate/PSVITA Develop/Zenonia2-vita"
APK_FILE="${BASE_DIR}/zenonia2-1-0-5.apk"
LIB_DIR="${BASE_DIR}/apk_extract/lib"
...
if command -v jadx >/dev/null 2>&1; then
  ...
  docker run --rm -v "${BASE_DIR}:/app" ubuntu:latest bash -c "
    ...
    ./jadx/bin/jadx -d /app/decompiled/apk_jadx /app/zenonia2-1-0-5.apk
  "
fi
