...
#
# Requiere que el directorio fuente temporal /tmp/zn2-src y el directorio de build
# /tmp/zn2-build ya estén configurados (el script build_and_install.sh hace esto).
#   mkdir -p /tmp/zn2-build && cd /tmp/zn2-build && cmake /tmp/zn2-src -DCMAKE_BUILD_TYPE=Debug
#
